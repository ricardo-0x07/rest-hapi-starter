  ...
  return RestHapi.generateModels(Mongoose)
    .then(function (result) {
      ...
      return dropCollections(models)
        ...
        .then(function (result) {
          groups = result;
          Log.log("seeding parents and admin");
          parents = [
            {
              firstName: 'test',
              lastName: 'editor',
          ...
          return RestHapi.create(models.user, parents, Log);
        })
        .then(function (result) {
          parents = result;
          console.log('parents: ', parents);
          console.log('models.user: ', models.user);
          Log.log("seeding children");
          children = [
            {
              firstName: 'test',
              lastName: 'user',
          ...
          return RestHapi.create(models.user, children, Log);
        })
         .then(function(results) {
          Log.log("get users");
           children = results
           console.log('children: ', children);
           return RestHapi.list(models.user, {isActive: true}, Log)
        })
        .then(function (result) {
          users = result.docs;
